...
namespace Infiniscryption.StarterDecks
{
    ...
    public class InfiniscryptionStarterDecksPlugin : BaseUnityPlugin
    {
        ...
        private string[] _deckEvolutionsConfig
        {
            ...
            {
                return new string[] {
                    Config.Bind("InfiniscryptionStarterDecks", "Deck1Evolution", "1=Wolf_Talking,3+2H&+WhackAMoleS,2=Alpha&+-1O,0+TailOnHitS,3+SharpS,2+-1O&+1H,0+DrawRabbitsS,1+FlyingS", new BepInEx.Configuration.ConfigDescription("This defines Starter Deck 1 - comma separated. The first card will be the one shown to the player to select.")).Value,
                    Config.Bind("InfiniscryptionStarterDecks", "Deck2Evolution", "3=Stoat_Talking&+1H&+QuadrupleBonesS,1+-1O,0+BeesOnHitS,2+SharpS,3+DeathtouchS,0+SplitStrikeS,2+PreventAttackS,1+DrawCopyOnDeathS", new BepInEx.Configuration.ConfigDescription("This defines Starter Deck 2 - comma separated. The first card will be the one shown to the player to select.")).Value,
