...
namespace Infiniscryption.P03KayceeRun.Sequences
{
    ...
    public class AscensionTransformerSequence : MonoBehaviour, ICustomNodeSequence
    {
        ...
        {
            this.leftTable.gameObject.transform.Find("Base/CardSlot/Quad").GetComponent<MeshRenderer>().material.mainTexture = AssetHelper.LoadTexture("card_slot_transformer");
